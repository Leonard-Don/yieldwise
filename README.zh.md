...
**还没做的** —— 见 [GitHub Issues](https://github.com/Leonard-Don/shanghai-yield-atlas/issues)：
- PDF / Excel 报表导出
- 公网 hosted demo
...
工具本身按 MIT 免费。如果你想要"方法论 + demo 数据集 + Excel 模板"的完整知识包，关注 [Discussions](https://github.com/Leonard-Don/shanghai-yield-atlas/discussions) —— 计划首次公开后 6 周内发布。
