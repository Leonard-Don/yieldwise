...
def test_feature_preview_canonicalizes_geometry_datum_alias(monkeypatch) -> None:
    from api import service
    ...
    view = build_geo_asset_run_view(
        {
            "runId": "geo-run-3",
            "batchName": "Geometry datum footprint sample",
            "createdAt": "2026-05-20T12:00:00+08:00",
            "features": [
                {
                    "type": "Feature",
                    "properties": {
                        ...
                        "building_id": "pudong-001-b001",
                        "building_name": "1号楼",
                        "source_ref": "amap://footprint/3",
                        "resolution_notes": "已命中楼栋词典",
                        "geometry_datum": " WGS_84 ",
                    },
                    "geometry": {"type": "Polygon", "coordinates": [[]]},
                }
            ],
...
def test_geo_run_comparison_rows_include_matching_datum_alias() -> None:
    current_detail = {
        "features": [
            {
                "type": "Feature",
